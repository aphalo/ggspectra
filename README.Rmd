...
[![cran-version](http://www.r-pkg.org/badges/version-last-release/ggspectra)](https://cran.r-project.org/package=ggspectra) [![downloads](http://cranlogs.r-pkg.org/badges/ggspectra)](https://cran.r-project.org/package=ggspectra) [![downloads-total](http://cranlogs.r-pkg.org/badges/grand-total/ggspectra)](https://cran.r-project.org/package=ggspectra)
