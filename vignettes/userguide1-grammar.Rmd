...
defined in packages `ggplot2`, `scales`, `ggrepel` and `cowplot`.

### What are `plot` specializations for?

The `plot` specializations produce fully annotated plots as `ggplot`
objects, which can be further manipulated if so desired. They use the
metadata stored in spectral objects of classes defined in package
'photobiology' to automatically generate suitable axis labels, scales
and annotations. (Please, see vignette "Plot methods" for details.)
...
+------------+-----------------+--------------------------------------+
| *stat*     | default *geom*  | other uses                           |
|            | (used for)      |                                      |
+:===========+:================+:=====================================+
| `s         | point           | wavelength label, spectral quantity  |
| tat_peaks` | (highlight      | label                                |
|            | maxima)         |                                      |
+------------+-----------------+--------------------------------------+
| `sta       | point           | wavelength label, spectral quantity  |
| t_valleys` | (highlight      | label                                |
|            | minima)         |                                      |
+------------+-----------------+--------------------------------------+
| `stat_la   | text            | spectral quantity label (support     |
| bel_peaks` | (wavelength     | 'ggrepel')                           |
|            | label)          |                                      |
+------------+-----------------+--------------------------------------+
| `stat_labe | text            | spectral quantity label (support     |
| l_valleys` | (wavelength     | 'ggrepel')                           |
|            | label)          |                                      |
+------------+-----------------+--------------------------------------+
| `stat      | point           | wavelength label, spectral quantity  |
| _find_wls` | (highlight wls  | label                                |
|            | at qty)         |                                      |
+------------+-----------------+--------------------------------------+
| `stat_     | point           | wavelength label, spectral quantity  |
| find_qtys` | (highlight qty  | label                                |
|            | at wl)          |                                      |
+------------+-----------------+--------------------------------------+
| `s         | color, fill     |                                      |
| tat_color` |                 |                                      |
+------------+-----------------+--------------------------------------+
| `stat      | text (waveband  | rect (showing range of waveband and  |
| _wb_label` | name)           | its color)                           |
+------------+-----------------+--------------------------------------+
| `stat      | text (y         | label(s) with waveband integral      |
| _wb_total` | integral)       |                                      |
+------------+-----------------+--------------------------------------+
| `sta       | text (y mean)   | label(s) with waveband mean          |
| t_wb_mean` |                 |                                      |
+------------+-----------------+--------------------------------------+
| `stat_w    | text (y mean)   | label with wavelength *range* mean   |
| l_summary` |                 |                                      |
+------------+-----------------+--------------------------------------+
| `s         | text            | label(s) with waveband integral /    |
| tat_wb_con | (contribution)  | whole spectrum integral              |
| tribution` |                 |                                      |
+------------+-----------------+--------------------------------------+
| `stat_wb   | text (relative) | label(s) with waveband integral /    |
| _relative` |                 | sum of integrals of all wavebands    |
+------------+-----------------+--------------------------------------+
| `stat_w    | text (energy    | rect (showing range of waveband and  |
| b_e_irrad` | irradiance)     | its color)                           |
+------------+-----------------+--------------------------------------+
| `stat_w    | text (photon    | rect (showing range of waveband and  |
| b_q_irrad` | irradiance)     | its color)                           |
+------------+-----------------+--------------------------------------+
| `stat_wb   | text (spectral  | rect (showing range of waveband and  |
| _e_sirrad` | energy          | its color)                           |
|            | irradiance)     |                                      |
+------------+-----------------+--------------------------------------+
| `stat_wb   | text (spectral  | rect (showing range of waveband and  |
| _q_sirrad` | photon          | its color)                           |
|            | irradiance)     |                                      |
+------------+-----------------+--------------------------------------+
| `stat      | rect (fill of   | text (label with waveband name)      |
| _wl_strip` | wavelength or   |                                      |
|            | waveband)       |                                      |
+------------+-----------------+--------------------------------------+
| `st        | rect (fill of   |                                      |
| at_wb_box` | waveband)       |                                      |
...
described in *User Guide 2: Plot Methods* together with plot
annotations.
