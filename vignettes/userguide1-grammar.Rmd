---
title: "User Guide: Grammar of Graphics"
...
output: 
  rmarkdown::html_vignette:
    toc: yes
vignette: >
  %\VignetteIndexEntry{User Guide: Grammar of Graphics}
...
In the next example we demonstrate a trick achieved by over-ploting two lines of different width (`size`) to make the spectrum visible on a background of variable luminosity and colour.
