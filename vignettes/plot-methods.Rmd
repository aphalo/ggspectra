...
In the examples above the `source_spct` object `sun.spct` was used. The `plot()` methods for other spectral classes have slight differentces. We show some examples for `filter_spct` objects.
