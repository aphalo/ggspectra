...
A different creterion for "filtering-out" peaks is their prominence compared to
...
```{r}
p0 +
  stat_peaks(colour = "red", size = 1, span = 11, local.threshold = 0.1)
```
...
```{r}
p0 +
  stat_peaks(colour = "red", size = 1, span = 11, local.threshold = I(0.1))
```
...
p0 +
  stat_peaks(colour = "red", size = 1, 
             span = 11, 
             local.threshold = I(0.1),
             global.threshold = I(0.6))
```
