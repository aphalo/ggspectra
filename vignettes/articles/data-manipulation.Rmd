...
Another use case is when a layer displays a summary spectrum computed from multiple spectra shown in a different plot layer. In the example below the blue line shows the median spectrum. Other spectra are semitransparent and show as grey lines.
