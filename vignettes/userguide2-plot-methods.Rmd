...
We can add an annotation to the defaults. In this case `"boundaries"`, an annotation that adds a horizontal dashed line and does not override any other annotation.
