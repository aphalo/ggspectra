...
library(knitr)
opts_chunk$set(fig.path = 'figure2/', fig.align = 'center', fig.show = 'hold',
...
Even though the `plot()` methods can return a finished plot, the returned object is a `ggplot` object and can be built upon by adding additional elements like _facets_, _aesthetics_ and even additional _layers_. We pass `idfactor = NA` to suppress the mapping of the spectra to `linetype`.
