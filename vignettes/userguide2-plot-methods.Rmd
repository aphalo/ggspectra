...
and subtitles. The `"title"` annotation takes optional modifiers that can be used to specify the contents of the title and subtitle. Currently supported modifiers are shown in the table below. If the metatdata item is not stored in the plotted spectral object, the title or subtitle will show `NA`. See the documentation of packages 'photobiology' and 'ooacquire' for information on how to set and unset attributes of spectral objects.

| Modifier | text source |
| -------- | ------------- |
