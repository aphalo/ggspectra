...
| `stat_wb_total` | rect (above data) | label(s) with waveband integral |
| `stat_wb_mean` | rect (showing integral) | label(s) with waveband mean |
| `stat_wb_summary` | rect (showing integral) | label with _range_ mean |
| `stat_wb_contribution` | rect (above data) | label(s) with waveband integral / whole spectrum integral |
| `stat_wb_relative` | rect (above data) | label(s) with waveband integral / sum of integrals of all wavebands |
