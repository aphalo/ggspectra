...
| `stat_`  | default               | other uses                                   |
|:----------|:---------------------|:----------------------------------------------|
| `peaks`        | point (highlight maxima)  | wavelength label, spectral quantity label |
| `valleys`        | point (highlight minima)  | wavelength label, spectral quantity label |
| `label_peaks`   |  text (wavelength label)  | spectral quantity label (support 'ggrepel') |
| `label_valleys`   | text (wavelength label)  | spectral quantity label (support 'ggrepel') |
| `color`         | color, fill |                                              |
| `wb_label` | text (waveband name) | rect (showing range of waveband and its color) |
| `wb_total` | rect (above data) | label(s) with waveband integral |
| `wb_mean` | rect (showing integral) | label(s) with waveband mean |
| `wb_summary` | rect (showing integral) | label with _range_ mean |
| `wb_contribution` | rect (above data) | label(s) with waveband integral / whole spectrum integral |
| `wb_relative` | rect (above data) | label(s) with waveband integral / sum of integrals of all wavebands |
| `wb_e_irrad` | text (energy irradiance) |  rect (showing range of waveband and its color) |
| `wb_q_irrad` |  text (photon irradiance) | rect (showing range of waveband and its color) |
| `wb_e_sirrad` | text (spectral energy irradiance) |  rect (showing range of waveband and its color) |
| `wb_q_sirrad` |  text (spectral photon irradiance) | rect (showing range of waveband and its color) |
| `wl_strip` |  rect (color of wavelength or waveband) | text (label with waveband name) |
