...
Functions for automatic generation of secondary x-axes in the case when a variable containing wavelength data (nm) is mapped to the _x_ _aesthetic_ simplify the task of adding an axis with frequencies or wavenumbers to the plot of a spectrum.
...
Functions for automating the addition of secundary axes are also defined.
...
Transformation objects for '**scales**', or user defined, can be also passed as arguments,
