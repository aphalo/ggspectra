...
test_that("waveband", {
  ...
  vdiffr::expect_doppelganger("waveband-default-cie-wl-range-shrink",
                              autoplot(CIE(),
                                       w.length = 200:400,
                                       range = c(230, 380)))
  vdiffr::expect_doppelganger("waveband-cie-range-shrink-long",
                              autoplot(CIE(),
                                       w.length = 200:400,
                                       range = c(230, 300, 380)))
  # vdiffr::expect_doppelganger("waveband-default-cie-wl-range-expand",
  #                             autoplot(CIE(),
  #                                      w.length = 250:350,
  #                                      range = c(200, 400)))
  # vdiffr::expect_doppelganger("waveband-default-cie-range-r",
