#' Create a complete ggplot for a solute spectrum.
#'
#' This function returns a ggplot object with an annotated plot of a solute_spct
#' object, by defaault showing spectral molar attenuation coefficient.
#'
#' @param spct a solute_spct object.
